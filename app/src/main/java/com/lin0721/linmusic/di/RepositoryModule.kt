...
val repositoryModule = module {
    ...
    single { com.lin0721.linmusic.core.player.data.LyricsCache(get<android.content.Context>().cacheDir) }
    single { com.lin0721.linmusic.core.player.data.AmllLyricsClient(get()) }
    single { com.lin0721.linmusic.core.player.domain.LyricResolver() }
